  ...
  async (payload, thunkAPI) => {
    try {
      await axios
        ...
        .post(`http://13.124.49.254:8080/team01/post`, payload, {
          headers: {
            enctype: "multipart/form-data",
            Access_Token:
              "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJrZWg1MTY0IiwiZXhwIjoxNjY3MDQ5ODY5LCJpYXQiOjE2NjcwNDgwNjl9.3Lm5Q0oVrQxCAig4xmCaSCNxbhbF0W3i6OEgn4Ivu0I",
          },
        })
        .then((response) => {
